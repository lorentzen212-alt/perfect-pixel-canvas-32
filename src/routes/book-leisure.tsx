...
function StepOne(props: {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-[minmax(240px,1fr)_minmax(240px,1fr)_minmax(180px,0.85fr)_minmax(280px,1.55fr)] gap-8 xl:gap-0">
