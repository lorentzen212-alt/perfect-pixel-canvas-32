...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;500&family=DM+Serif+Display:wght@400&family=Cormorant+Garamond:ital,wght@0,400;0,500;0,600;0,700;1,400;1,500;1,600&family=Karla:wght@300;400;500;600&family=Inter:wght@400&family=Libre+Baskerville:ital,wght@0,400;0,700;1,400&family=IBM+Plex+Sans:ital,wght@0,400;0,500;0,600;1,400&family=Mrs+Saint+Delafield&display=swap" },
    ],
  }),
...
function AuthEvents({ queryClient }: { queryClient: QueryClient }) {
  const router = useRouter();
  useEffect(() => {
...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <AuthProvider>
        <AuthEvents queryClient={queryClient} />
