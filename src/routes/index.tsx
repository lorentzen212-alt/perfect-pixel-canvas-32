...
function ExperienceCard({
  ...
  image,
  imagePosition = "center center",
  imageFilter = "brightness(1.80) contrast(1.15) saturate(0.96) hue-rotate(-2deg) sepia(0.08)",
    ...
    >
      ...
      >
        ...
        <div className="relative aspect-[12/13.6] overflow-hidden">
          ...
          />
          {/* Shadow lift — gently lifts dark bottom/lower-mid tones for a brighter, more open feel */}
          <div
            aria-hidden
            className="pointer-events-none absolute inset-0 mix-blend-soft-light"
            style={{
              background:
                "linear-gradient(to top, rgba(255,246,228,0.10) 0%, rgba(255,242,220,0.04) 32%, transparent 58%)",
            }}
          />
