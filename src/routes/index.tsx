...
const TRUST = [
  { Icon: ShieldCheckPremium, label: "No commitment", size: 44 },
  { Icon: ClockPremium, label: "Fast and free", size: 44 },
  { Icon: HeadsetPremium, label: "Expert support", size: 50 },
  { Icon: LockPremium, label: "Secure & trusted", size: 44 },
];
