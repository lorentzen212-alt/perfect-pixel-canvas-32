...
export function BrandLogo({
  ...
  const badgeColor = tone === "light" ? "#12222F" : "#FFFFFF";
  const badgeBorder =
    tone === "light" ? "1px solid rgba(18,34,47,0.16)" : "1px solid rgba(255,255,255,0.16)";
  const badgeBg = tone === "light" ? "rgba(18,34,47,0.05)" : "rgba(255,255,255,0.06)";
    ...
    return (
      <span
        ...
        style={{
          ...
          background: tone === "light" ? "rgba(18,34,47,0.06)" : "rgba(255,255,255,0.08)",
        }}
      >
        HGB
      </span>
